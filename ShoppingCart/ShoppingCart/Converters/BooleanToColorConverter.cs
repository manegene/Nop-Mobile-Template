...
namespace habahabamall.Converters
{
    ...
    /// This is needed to validate in the Entry controls. If the validation is failed, it will return the color code of
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            switch (parameter.ToString())
            {
                ...
                case "4" when (bool)value:
                    _ = Application.Current.Resources.TryGetValue("PrimaryColor", out object retVal);
                    return (Color)retVal;
                case "4":
                    _ = Application.Current.Resources.TryGetValue("Gray-600", out object outVal);
                    return (Color)outVal;
                case "5" when (bool)value:
                    _ = Application.Current.Resources.TryGetValue("Green", out object retGreen);
                    return (Color)retGreen;
                case "5":
                    _ = Application.Current.Resources.TryGetValue("Red", out object retRed);
                    return (Color)retRed;
                default:
