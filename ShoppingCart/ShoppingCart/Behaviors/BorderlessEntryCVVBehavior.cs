...
namespace habahabamall.Behaviors
{
    ...
    public class BorderlessEntryCVVBehavior : Behavior<BorderlessEntry>
    {
        ...
        protected override void OnAttachedTo(BorderlessEntry borderlessEntry)
        {
            ...
            borderlessEntry.BindingContextChanged += OnBindingContextChanged;
            borderlessEntry.TextChanged += OnTextChanged;
        }
        ...
        protected override void OnBindingContextChanged()
        {
            ...
            BindingContext = BorderlessEntry.BindingContext;
        }
