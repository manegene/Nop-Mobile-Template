...
namespace habahabamall.Behaviors
{
    ...
    public class SfComboBoxDropDownBehavior : Behavior<SfComboBox>
    {
        ...
        {
            _ = int.TryParse(e.Value.ToString(), out int totalQuantity);

            object bindingContext = (sender as SfComboBox).BindingContext;

            System.Reflection.PropertyInfo propertyInfo = bindingContext.GetType().GetProperty("TotalQuantity");
