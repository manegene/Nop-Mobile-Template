    ...
    public class ErrorValidationColorConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (PageVariantParameter == "0")
            {
                ...
                return isFocused ? Color.FromRgba(255, 255, 255, 0.6) : (object)(bindingContext.IsInvalidEmail ? Color.FromHex("#FF4A4A") : Color.Transparent);
            }
            ...
            else
            {
                ...
                return isFocused1 ? Color.FromHex("#959eac") : (object)(bindingContext.IsInvalidEmail ? Color.FromHex("#FF4A4A") : Color.FromHex("#ced2d9"));
            }
        }
