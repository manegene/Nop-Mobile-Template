...
namespace habahabamall.Helpers
{
    ...
    public static class RTLHelper
    {
        ...
        private static void OnMarginPropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            Thickness previousMargin = (Thickness)oldValue;
            Thickness currentMargin = (Thickness)newValue;
        ...
        private static void OnPaddingPropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            Thickness previousPadding = (Thickness)oldValue;
            Thickness currentPadding = (Thickness)newValue;
        ...
        private static void OnCornerRadiusPropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            Thickness previousCornerRadius = (Thickness)oldValue;
            Thickness currentCornerRadius = (Thickness)newValue;
        ...
        private static void UpdateMargin(VisualElement view)
        {
            ...
            Thickness margin = GetMargin(view);
        ...
        private static void UpdatePadding(View layout)
        {
            ...
            Thickness padding = GetPadding(layout);
        ...
        {
            IVisualElementController controller = view;
            Thickness cornerRadius = GetCornerRadius(view);
