...
using habahabamall.ViewModels.ContactUs;
using Xamarin.Forms;
using Xamarin.Forms.Internals;
using Xamarin.Forms.Xaml;

namespace habahabamall.Views.ContactUs
{
    /// <summary>
    ...
    public partial class ContactUsPage
    {
        ...
        public ContactUsPage()
        {
            ...
            BindingContext = new ContactUsViewModel(userDataService);
        }
        ...
        protected override void OnSizeAllocated(double width, double height)
        {
            ...
            if (width > height)
            {
                if (Device.Idiom == TargetIdiom.Desktop || Device.Idiom == TargetIdiom.Tablet)
                {
                    ...
                    if (frameWidth > 0)
                    {
                        MainFrame.WidthRequest = frameWidth;
                        Map.WidthRequest = frameWidth;
                    }
                }
                else
                {
